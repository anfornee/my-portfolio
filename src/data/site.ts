export const site = {
	...
	hero: {
		...
		personal:
			'My path through coffee, audio, entrepreneurship, and enterprise software has shaped how I think about craft, systems, and the people on the other side of what I build.',
	},
	navigation: [
	...
	technologyGroups: [
		{
			label: 'Application',
			items: ['React', 'Next.js', 'TypeScript', 'Node', 'SCSS Modules'],
		},
		{
		...
		{
			label: 'Delivery',
			items: ['Docker', 'Terraform', 'GitLab CI/CD', 'SAML SSO'],
		},
		{
			label: 'Platforms and media',
			items: ['Bedrock', 'WordPress VIP', 'HLS', 'Salesforce APIs', 'i18n'],
		},
	],
	connect: [
		{ label: 'Email', href: 'mailto:contact@theanthonypereira.com' },
		{ label: 'LinkedIn', href: 'https://www.linkedin.com/in/anthony-luis-pereira' },
